...
* For Rails 2.x
    ...
    script/generate plugin install git@github.com:coroutine/simple_navigation.git
    
=== As a gem

    gem install simple_navigation


Then, simply call:

    script/generate simple_navigation
    
This will place the simple_navigation.rb config file into your config directory.
